...
### Demo
[Lihat Demo](https://aglalrizal.github.io/fcc-jsads-a-decimal-to-binary-converter/)
...
1. Clone repository ini:
   ```bash
   git clone https://github.com/aglalrizal/fcc-jsads-a-decimal-to-binary-converter.git
